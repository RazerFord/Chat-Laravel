                ...
                <div class="col-md-6 col-lg-7 col-xl-8">
                    ...
                    <div class="bg-white mb-3">
                        <div class="form-outline">
                            <textarea id="message" class="form-control" id="textAreaExample2" rows="4"
                                style="resize: none;"></textarea>
                            <label class="form-label" for="textAreaExample2">Сообщение</label>
                        </div>
                        <button id="sendButton" onclick="sendMessage()" type="button"
                            class="btn btn-info btn-rounded float-end">Отправить</button>
                    </div>
                </div>
            </div>
        </div>
